...
class TrueAIBrain:
    ...
    def __init__(self):
        ...
        # אוצר תשובות חכמות שנלמדות
        self.knowledge_base = {
            "who_are_you": [
                "אני אדיאל ג'וניור, עוזרת AI עם קול מקורי רק שלך, בנויה מאפס. המוח שלי הוא פרטי, לא wrapper.",
                "אני אדיאל - מודל AI אמיתי עם embedding, attention, ו-Markov chain שמייצר משפטים, לא תבניות.",
            ],
            "what_can_you_do": [
                "אני יכולה לזכור אותך, ללמוד מילים חדשות, לנתח מסך, לשלוט במחשב בקול, ולנהל שיחה אמיתית. וגם יש לי קול מקורי רק שלך!",
                "אני רואה מסך חי, מבינה עברית עם סלנג, זוכרת שיחות, מציעה שיפורים שדורשים אישור, ויש לי בחירת מיקרופון.",
            ],
            "how_do_you_work": [
                "המוח שלי בנוי מ-4 שכבות: טוקנייזר עברי מאפס, embedding layer, attention, ומנוע Markov שמייצר טקסט. כל שיחה אני לומדת ומשתפרת.",
                "אני לא קוראת ל-API חיצוני כברירת מחדל. הכל רץ לוקלית: TF-IDF, cosine similarity, ו-Markov chain מאפס עם numpy.",
            ]
        }
