...
class HebrewIntentClassifier:
    def __init__(self):
        ...
        self.intents_keywords = {
            ...
            "how_are_you": [
                ...
                "מה הולך", "מה המצב", "מה נהיה", "מה נשמע בדיוק", "ווסאפ", "וואטסאפ", "whats up", "sup",
                "הכול טוב", "הכל טוב", "מה עושה"
            ],
            "thanks": [
    ...
    def _train_simple_model(self):
        ...
        self.training_data = [
            ...
            ("מה הולך", "how_are_you"),
            ("מה הולך אחי", "how_are_you"),
            ("מה המצב", "how_are_you"),
            ("מה נהיה", "how_are_you"),
            ("מה שלומך היום", "how_are_you"),
            ("הכול בסדר איתך", "how_are_you"),
    ...
    _STOPWORDS = {
        ...
        "מה", "למה", "כמה", "איך", "מי", "מתי", "איפה", "איזה", "איזו",
